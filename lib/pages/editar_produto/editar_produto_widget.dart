...
class _EditarProdutoWidgetState extends State<EditarProdutoWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.editarProdutoItem = await CupcakesTable().queryRows(
    ...
    _model.saborProdutoTextController ??=
        TextEditingController(text: widget.sabor);
                            ...
                            children: [
                              Align(
                                ...
                                child: Stack(
                                  children: [
                                    Builder(
                                      key: ValueKey(false.toString()),
                                      builder: (context) {
                                        if (FFAppState().changeImageInProduct) {
                                          return Column(
                                            mainAxisSize: MainAxisSize.max,
                                            children: [
                                              Stack(
                                    ...
                                    Align(
                                      alignment:
                                          const AlignmentDirectional(0.39, -0.87),
                                      child: InkWell(
                                        splashColor: Colors.transparent,
                                        focusColor: Colors.transparent,
                                        hoverColor: Colors.transparent,
                                        ...
                                        onTap: () async {
                                          ...
                                          FFAppState().changeImageInProduct =
                                              true;
                                          safeSetState(() {});
                                        },
                                        child: Icon(
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await CupcakesTable().update(
                                    data: {
                                      'nome':
                                          _model.nomeProdutoTextController.text,
                                      'sabor': _model
                                          .saborProdutoTextController.text,
                                      'valor': int.tryParse(_model
                                          .valorProdutoTextController.text),
