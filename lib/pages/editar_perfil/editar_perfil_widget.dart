...
class _EditarPerfilWidgetState extends State<EditarPerfilWidget> {
  ...
  void initState() {
    ...
    _model.nomeTextController ??=
        TextEditingController(text: FFAppState().nomeUsuario);
    ...
    _model.ruaTextController ??= TextEditingController(text: FFAppState().rua);
    ...
    _model.estadoTextController ??=
        TextEditingController(text: FFAppState().estado);
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          context.goNamed('ListarProdutos');

                          FFAppState().SideVisibility = false;
                          safeSetState(() {});
                          _model.editarUsuario = await UsuariosTable().update(
                            data: {
                          ...
                          FFAppState().email =
                              _model.editarUsuario!.first.email;
                          FFAppState().nomeUsuario =
                              _model.editarUsuario!.first.nome!;
                          FFAppState().rua = _model.editarUsuario!.first.rua!;
                          FFAppState().bairro =
                              _model.editarUsuario!.first.bairro!;
                          FFAppState().cidade =
                              _model.editarUsuario!.first.cidade!;
                          FFAppState().estado =
                              _model.editarUsuario!.first.estado!;
                          safeSetState(() {});
