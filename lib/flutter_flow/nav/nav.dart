...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => const EntrarWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => const EntrarWidget(),
        ),
        FFRoute(
          name: 'Entrar',
          path: '/entrar',
        ...
        FFRoute(
          name: 'NovoUsuario',
          path: '/novoUsuario',
          builder: (context, params) => const NovoUsuarioWidget(),
        ),
        FFRoute(
          name: 'ListarProdutos',
          path: '/listarProdutos',
          builder: (context, params) => const ListarProdutosWidget(),
        ),
        FFRoute(
          name: 'EditarPerfil',
          path: '/editarPerfil',
